/* =========================================================
   ...
   ========================================================= */
// the original bunny player; other looks come from npcModel (57-villagers), see 59-player
function bunnyBody(fur=0xf6f3ee,shirt=0xd8453a){return M([P(ICO2,fur,0,0.46,0,0,0,0,0.5,0.46,0.46),P(ICO2,fur,0,0.36,-0.16,0,0,0,0.12,0.12,0.1),
  P(ICO2,fur,-0.2,0.22,0.03,0,0,0.5,0.08,0.16,0.08),P(ICO2,fur,0.2,0.22,0.03,0,0,-0.5,0.08,0.16,0.08),P(ICO2,fur,0,0.14,-0.16,0,0,0,0.1,0.1,0.1),P(CYL12,0xf4f0ea,0,0.27,0,0,0,0,0.26,0.03,0.22),
  P(ICO2,fur,-0.12,0.74,0,0,0,0.15,0.1,0.26,0.08),P(ICO2,fur,0.12,0.74,0,0,0,-0.15,0.1,0.26,0.08),
  ...
  P(CYL12,shirt,0,0.16,0,0,0,0,0.3,0.2,0.26),P(ICO2,0xf6d04a,0,0.2,0.135,0,0,0,0.035,0.035,0.02),P(ICO2,0xf6d04a,0,0.13,0.14,0,0,0,0.035,0.035,0.02),P(BOX,shirt,0.13,0.13,0.14,0,0,0.3,0.07,0.14,0.03),
  P(ICO,fur,-0.19,0.17,0.02,0,0,0,0.1,0.1,0.1),P(ICO,fur,0.19,0.17,0.02,0,0,0,0.1,0.1,0.1),
...
{villager.add(bunnyBody());scene.add(villager);}

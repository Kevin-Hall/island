...
function npcModel(sp,col,shirt,acc){const p=[],dk=new T.Color(col).multiplyScalar(0.75).getHex(),hi=new T.Color(col).lerp(new T.Color(0xffffff),0.45).getHex(),sdk=new T.Color(shirt).multiplyScalar(0.78).getHex();
  ...
  switch(sp){
    case'fox':p.push(P(CONE4,col,-0.16,0.82,0,0,0.785,0.28,0.13,0.24,0.08),P(CONE4,col,0.16,0.82,0,0,0.785,-0.28,0.13,0.24,0.08),P(CONE4,0x3a2a2a,-0.2,0.92,0,0,0.785,0.28,0.06,0.08,0.05),P(CONE4,0x3a2a2a,0.2,0.92,0,0,0.785,-0.28,0.06,0.08,0.05),
      P(CONE4,0xfbf4ea,-0.15,0.8,0.02,0,0.785,0.28,0.06,0.12,0.04),P(CONE4,0xfbf4ea,0.15,0.8,0.02,0,0.785,-0.28,0.06,0.12,0.04),
      P(ICO2,0xfbf4ea,-0.13,0.44,0.14,0,0,0.5,0.15,0.1,0.1),P(ICO2,0xfbf4ea,0.13,0.44,0.14,0,0,-0.5,0.15,0.1,0.1),P(ICO2,0xfbf4ea,0,0.45,0.2,0,0,0,0.13,0.09,0.08),P(ICO2,0x2b1e2e,0,0.49,0.27,0,0,0,0.04,0.03,0.03),
      P(ICO2,col,0,0.3,-0.3,0.9,0,0,0.14,0.3,0.14),P(ICO2,dk,0,0.36,-0.4,0.9,0,0,0.12,0.14,0.12),P(ICO2,0xfbf4ea,0,0.46,-0.47,0.9,0,0,0.1,0.1,0.1));break;

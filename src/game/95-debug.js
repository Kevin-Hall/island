...
if(/[?&]debug\b/.test(location.search)){
  ...
  window.DS={
    ...
    pick:(cx,cy)=>pick(cx,cy),calls:()=>{const out={};const names=new Map([[debrisRoot,'debris'],[lifeRoot,'life']]);try{names.set(cropRoot,'crops');}catch(e){}try{names.set(objRoot,'objs');}catch(e){}

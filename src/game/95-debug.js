...
if(/[?&]debug\b/.test(location.search)){
  ...
  window.DS={
    ...
    pick:(cx,cy)=>pick(cx,cy),npcAt:i=>{const n=npcs[i];return[n.x,n.z];},bldAt:t=>{const b=TOWN.bld.find(q=>q.t===t);return b?[b.x,b.z]:null;},calls:()=>{const out={};const names=new Map([[debrisRoot,'debris'],[lifeRoot,'life']]);try{names.set(cropRoot,'crops');}catch(e){}try{names.set(objRoot,'objs');}catch(e){}
